      ...
      <section className="bg-gradient-to-r from-sky-50 via-blue-50 to-white px-6 py-16">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-700">
            NJSchoolCareers features more than 500 New Jersey education jobs and helps schools connect directly with candidates.
          </p>
      ...
      <section className="px-6 py-14">
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-3 text-xl font-semibold">Candidate Applications</h2>
            <p className="mt-3 text-sm leading-7 text-slate-600">
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 text-left shadow-sm">
              ...
              <p className="mt-2 text-sm font-semibold text-orange-600">
                Featured placement options coming soon.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold">
                Start reaching New Jersey candidates today.
              </h2>
