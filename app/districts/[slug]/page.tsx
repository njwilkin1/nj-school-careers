...
export async function generateMetadata({
  ...
  return {
    title: `${districtName} Jobs | NJSchoolCareers`,
    description: `Browse current job openings for ${districtName} in New Jersey.`,
  };
}
    ...
    <main className="min-h-screen bg-slate-50 px-6 py-12">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-4 text-lg text-slate-700">
          Browse current job openings with {districtName}
          through NJSchoolCareers.
        </p>
